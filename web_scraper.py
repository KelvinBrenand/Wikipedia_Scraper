...
if re.search('<p><b>A Wikipédia não possui um artigo com este nome exato.</b>', file.read()): #Verifica se o artigo existe REGEX#2
...
while True:
    ...
    if option == '1':
        ...
        while True:
            line = file.readline()
            regex1 = re.compile('class="floatnone"><a href="/wiki/Ficheiro:\S+"|class="magnify"><a href="/wiki/Ficheiro:\S+') #REGEX#5
            list1.append(regex1.findall(line))
            if "" == line:
                break
